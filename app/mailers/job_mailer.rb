class JobMailer < ApplicationMailer
	...
	def saved(email, job, user)
		@job = job
		@user = user
		@propic = @user.avatar.url || "http://intajobs.com/assets/images/propic.jpg"
		@thumb = @user.avatar.thumb.url || "http://intajobs.com/assets/images/propic_thumb.jpg"
	...
	def match(candidate, job)
		@candidate = candidate
		@job = job
		@thumb = @candidate.avatar.thumb.url || "http://intajobs.com/assets/images/propic_thumb.jpg"
		domain = ENV["DOMAIN"] || "instajobs.io"; 
